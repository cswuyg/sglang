...
class BeamSearchTokenizerManagerMixin:
    def build_beam_search_out(self, out: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        nvtx.range_push("beam_search:build_output")
        beam_results = out.get("beam_results", [])
        if not beam_results:
            nvtx.range_pop()  # beam_search:build_output
            return out
    ...
    def _build_beam_search_out_dict(
        ...
        nvtx.range_push("beam_search:build_out_dict")
        beam_results = []
        ...
        nvtx.range_pop()  # beam_search:build_out_dict
