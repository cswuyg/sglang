...
class TestBeamSearchDiff(unittest.TestCase):
    ...
    def test_beam_search_different_widths(self):
        ...
        for beam_width in beam_widths:
            ...
            print(f"\n[transformers] {len(transformers_sequences)} sequences:")
            for i, seq in enumerate(transformers_sequences):
                print(f"  [{i}] {seq!r}")
            print(f"\n[sglang] {len(sglang_sequences)} sequences:")
            for i, seq in enumerate(sglang_sequences):
                print(f"  [{i}] {seq!r}")
